...
class FollowsControllerTest < ActionController::TestCase
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post :create, follow: { following_id: @follow.following_id, type: @follow.type, user_id: @follow.user_id }
    end
  ...
  test "should update follow" do
    put :update, id: @follow, follow: { following_id: @follow.following_id, type: @follow.type, user_id: @follow.user_id }
    assert_redirected_to follow_path(assigns(:follow))
  end
